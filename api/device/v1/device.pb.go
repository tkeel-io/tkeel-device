...
var file_api_device_v1_device_proto_rawDesc = []byte{
	...
	0x52, 0x06, 0x65, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x32, 0x86, 0x0b, 0x0a, 0x06, 0x44, 0x65, 0x76,
...
var file_api_device_v1_device_proto_msgTypes = make([]protoimpl.MessageInfo, 23)
var file_api_device_v1_device_proto_goTypes = []interface{}{
	...
	(*Condition)(nil),               // 18: api.device.v1.Condition
	(*Ids)(nil),                     // 19: api.device.v1.Ids
	(*Keys)(nil),                    // 20: api.device.v1.Keys
	(*Ext)(nil),                     // 21: api.device.v1.Ext
	(*Enable)(nil),                  // 22: api.device.v1.Enable
	(*v1.EntityResponse)(nil),       // 23: api.core.v1.EntityResponse
	(*v1.ListEntityResponse)(nil),   // 24: api.core.v1.ListEntityResponse
...
var file_api_device_v1_device_proto_depIdxs = []int32{
	...
	23, // 1: api.device.v1.CreateDeviceResponse.deviceObject:type_name -> api.core.v1.EntityResponse
	14, // 2: api.device.v1.UpdateDeviceRequest.devBasicInfo:type_name -> api.device.v1.DeviceEntityBasicInfo
	23, // 3: api.device.v1.UpdateDeviceResponse.deviceObject:type_name -> api.core.v1.EntityResponse
	19, // 4: api.device.v1.DeleteDeviceRequest.ids:type_name -> api.device.v1.Ids
	23, // 5: api.device.v1.GetDeviceResponse.deviceObject:type_name -> api.core.v1.EntityResponse
	17, // 6: api.device.v1.ListDeviceRequest.listEntityQuery:type_name -> api.device.v1.ListEntityQuery
	24, // 7: api.device.v1.ListDeviceResponse.listDeviceObject:type_name -> api.core.v1.ListEntityResponse
	22, // 8: api.device.v1.EnableDeviceRequest.enable:type_name -> api.device.v1.Enable
	25, // 9: api.device.v1.AddDeviceExtRequest.ext:type_name -> google.protobuf.Value
	20, // 10: api.device.v1.DeleteDeviceExtRequest.keys:type_name -> api.device.v1.Keys
	25, // 11: api.device.v1.UpdateDeviceExtRequest.ext:type_name -> google.protobuf.Value
	...
	25, // 14: api.device.v1.DeviceEntityBasicInfo.ext:type_name -> google.protobuf.Value
	18, // 15: api.device.v1.ListEntityQuery.condition:type_name -> api.device.v1.Condition
	0,  // 16: api.device.v1.Device.CreateDevice:input_type -> api.device.v1.CreateDeviceRequest
	2,  // 17: api.device.v1.Device.UpdateDevice:input_type -> api.device.v1.UpdateDeviceRequest
	4,  // 18: api.device.v1.Device.DeleteDevice:input_type -> api.device.v1.DeleteDeviceRequest
	5,  // 19: api.device.v1.Device.GetDevice:input_type -> api.device.v1.GetDeviceRequest
	7,  // 20: api.device.v1.Device.SearchEntity:input_type -> api.device.v1.ListDeviceRequest
	10, // 21: api.device.v1.Device.AddDeviceExt:input_type -> api.device.v1.AddDeviceExtRequest
	11, // 22: api.device.v1.Device.DeleteDeviceExt:input_type -> api.device.v1.DeleteDeviceExtRequest
	12, // 23: api.device.v1.Device.UpdateDeviceExt:input_type -> api.device.v1.UpdateDeviceExtRequest
	1,  // 24: api.device.v1.Device.CreateDevice:output_type -> api.device.v1.CreateDeviceResponse
	3,  // 25: api.device.v1.Device.UpdateDevice:output_type -> api.device.v1.UpdateDeviceResponse
	26, // 26: api.device.v1.Device.DeleteDevice:output_type -> google.protobuf.Empty
	6,  // 27: api.device.v1.Device.GetDevice:output_type -> api.device.v1.GetDeviceResponse
	8,  // 28: api.device.v1.Device.SearchEntity:output_type -> api.device.v1.ListDeviceResponse
	26, // 29: api.device.v1.Device.AddDeviceExt:output_type -> google.protobuf.Empty
	26, // 30: api.device.v1.Device.DeleteDeviceExt:output_type -> google.protobuf.Empty
	26, // 31: api.device.v1.Device.UpdateDeviceExt:output_type -> google.protobuf.Empty
